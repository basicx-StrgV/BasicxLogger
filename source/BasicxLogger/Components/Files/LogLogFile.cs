...
namespace BasicxLogger.Files
{
    ...
    /// </summary>
    public class LogLogFile : ILogFile
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicxLogger.Files.LogLogFile"/> class
        /// </summary>
        ...
        public LogLogFile(string directoryPath, string fileName)
        {
            ...
            _file = new FileInfo(directoryPath + fileName.Split('.')[0].Trim() + ".log");
        }
